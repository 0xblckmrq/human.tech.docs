...
<Callout type="info">
Stamps are added and removed from the the Passport service as the product evolves. To learn more, please visit our [Stamps overview for developers](/passport/building-with-passport/stamps/create-a-stamp).
