...
The example below shows the JSON data format for a Human Passport. This is an example of a Decentralized Identifier (DID), as defined in the [W3C documentation](https://w3c.github.io/did-core/#a-simple-example). Each passport contains a field named `stamps`. This is an array where your Stamps are stored.
...
Web3 citizens interface with the Passport Protocol through the Passport holder dApp at [app.passport.xyz](https://app.passport.xyz). Developers can use the [Stamps API](/passport/building-with-passport/stamps/passport-api) to easily integrate Human Passport into their apps.



### Passport-Gating

"Passport gating" means integrating the Passport Protocol into an app for the purpose of screening accounts to keep out bots, bad actors, or simply real people who don't meet a certain [threshold](/passport/building-with-passport/stamps/major-concepts/scoring-thresholds) of trustworthiness.
...
See our [quick start guide](/passport/building-with-passport/stamps/passport-api/quick-start-guide) to learn how to gate your project.
...
<Callout type="info">
Stamps are added and removed from the Passport service as the product evolves. To learn more, please visit our [Stamps overview for developers](/passport/building-with-passport/stamps/create-a-stamp).
...
More details about Passport deduplication can be found on our [Deduplicating Stamps](/passport/building-with-passport/stamps/major-concepts/deduplicating-stamps) page.
...
More detail, including an explanation of how to navigate paginated responses, is provided in the [API reference](/passport/building-with-passport/stamps/passport-api/api-reference).
