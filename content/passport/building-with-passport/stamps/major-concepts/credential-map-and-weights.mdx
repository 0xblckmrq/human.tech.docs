...
If you'd like to customize these credentials, you can do so with [Custom Passport](/passport/building-with-passport/stamps/custom-passport)
...
| ETH Activity | ETHScore#50, ETHScore#75, ETHScore#90     | Updated                 | Dec 18, 2024  | We rebuilt the back end of the ETH Activity Stamp to use our [aggregate model](/passport/building-with-passport/models/available-models) as opposed to just the ETH L1 model |