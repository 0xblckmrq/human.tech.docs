...
3. You can follow our simple [quick start guide](/passport/building-with-passport/stamps/passport-api/quick-start-guide) to quickly and easily start defending your app from Sybils!
...
Finally, you might not necessarily want to automatically gate access based on Passport scores or Stamps. Perhaps you want to display Stamp and score information about each user so platform administrators or end users can make real-time decisions based on the user's trustworthiness or reputation. For example, you might have to determine an honest user from several impersonator accounts. Quick access to Stamp and score data would give you a strong signal about who is the genuine user. There is a guide for displaying Stamp and score data in your app's UI in our [API reference](/passport/building-with-passport/stamps/passport-api/api-reference).

Read more on [How Passport works](/passport/overview/).

Start building using our [quick start guide](/passport/building-with-passport/stamps/passport-api/quick-start-guide).
...
Human Passport is already protecting many real world applications! You can read about active integrations on the [Active Integrations](/passport/overview/active-integrations) page and on the [blog](https://passport.human.tech/blog).

### Where to go from here?

* Read more about [how Passport works](/passport/overview/why-human-passport)
