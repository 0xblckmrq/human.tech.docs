...
A very common [use case](/passport/overview/use-cases) for Human Passport is gating access based on Passport scores.
...
Learn more about custom Scorers in our [API reference](/passport/building-with-passport/stamps/passport-api/api-reference).
