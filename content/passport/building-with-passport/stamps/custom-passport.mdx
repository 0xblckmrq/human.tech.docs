...
| Curate Stamps and weights                | Remove any Stamps or credentials that don’t make sense for your ecosystem, and adjust the remaining [credential weights](/passport/building-with-passport/stamps/major-concepts/credential-map-and-weights) to better reflect your ecosystem’s needs.                                                                                                                                                                                                                                   |
...
[Credential Map and Weights](/passport/building-with-passport/stamps/major-concepts/credential-map-and-weights)
...
If you are just checking scores from your Custom Passport offchain, you can use the [Stamps API v2](/passport/building-with-passport/stamps/passport-api) to access your users' data.

If, instead, you're enabling your users to push their Passport onchain and you are using a [custom scorer](#custom-scorer), you will need to use the [Decoder contract](/passport/building-with-passport/stamps/smart-contracts/contract-reference#decoder-contract), and more specifically, the `getScore` (0xdaadd662) method, making sure to pass both your [scorer ID](/passport/building-with-passport/stamps/passport-api/getting-access) and the specified wallet address to pull users' custom scores. 