...
More detailed information about this API's endpoints can be found in the [API reference](/passport/building-with-passport/stamps/passport-api/api-reference).