...
To prevent multiple Passports from verifying the same credential (enhancing security against Sybil attacks), Stamps are [deduplicated](/passport/building-with-passport/stamps/major-concepts/deduplicating-stamps) across addresses.
