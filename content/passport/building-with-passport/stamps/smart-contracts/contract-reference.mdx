...
| Optimism Sepolia      | 0xe53C60F8069C2f0c3a84F9B3DB5cf56f3100ba56 | [Optimism Explorer](https://sepolia-optimism.etherscan.io/address/0xe53C60F8069C2f0c3a84F9B3DB5cf56f3100ba56)   |
...
This alternative flow represents a subset of the tasks that the decoder contract automatically works through, which is why we don't recommend using it. It is, however, useful to understand. 
...
| contract        | address                                    | link                                                                                                 |
| --------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| issuer          | 0x4200000000000000000000000000000000000021 | [Optimism Explorer](https://sepolia-optimism.etherscan.io/address/0x4200000000000000000000000000000000000021)      |
| EAS             | 0x4200000000000000000000000000000000000020 | [Optimism Explorer](https://sepolia-optimism.etherscan.io/address/0x4200000000000000000000000000000000000020)      |
| GitcoinResolver | 0x074761E1Dc6E6cF9cdeE67dd180E01E818716Ce0 | [Optimism Explorer](https://sepolia-optimism.etherscan.io/address/0x074761E1Dc6E6cF9cdeE67dd180E01E818716Ce0) |
| GitcoinVerifier | 0x8D21C3360dcE1a9EBD3Da4373c4dAB7F81dd7233 | [Optimism Explorer](https://sepolia-optimism.etherscan.io/address/0x8D21C3360dcE1a9EBD3Da4373c4dAB7F81dd7233)      |
| GitcoinAttester | 0x8B1A76795e3CbadD79C5410d2C4D4827D9C1503a | [Optimism Explorer](https://sepolia-optimism.etherscan.io/address/0x8B1A76795e3CbadD79C5410d2C4D4827D9C1503a)      |
...
We discuss the Human Passport attestation schema in our [Attestation schema](/passport/building-with-passport/stamps/smart-contracts/attestation-schema) guide. 
