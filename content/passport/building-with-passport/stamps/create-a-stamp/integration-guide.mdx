...
<Callout type="info">
This guide is for approved partners who are ready to build their Stamp integration. If you haven't been approved yet, start with the [Introduction](/passport/building-with-passport/stamps/create-a-stamp/introduction).
</Callout>
...
Follow the [Submission Checklist](/passport/building-with-passport/stamps/create-a-stamp/integrating-a-new-stamp) for PR requirements.
</Steps>
...
- Review specific [Implementation Patterns](/passport/building-with-passport/stamps/create-a-stamp/implementation-patterns) for your use case
- Check out complete [Code Examples](/passport/building-with-passport/stamps/create-a-stamp/examples) 
- Learn about [Testing & Security](/passport/building-with-passport/stamps/create-a-stamp/testing-and-security) requirements
- Use the [Submission Checklist](/passport/building-with-passport/stamps/create-a-stamp/integrating-a-new-stamp) when ready to submit

## Support

For technical questions during development:
- Review the [troubleshooting guide](/passport/building-with-passport/stamps/create-a-stamp/testing-and-security#troubleshooting)
