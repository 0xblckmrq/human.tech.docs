...
2. Review complete [Code Examples](/passport/building-with-passport/stamps/create-a-stamp/examples) for your pattern
3. Learn about [Testing & Security](/passport/building-with-passport/stamps/create-a-stamp/testing-and-security) requirements
4. Follow the [Submission Checklist](/passport/building-with-passport/stamps/create-a-stamp/integrating-a-new-stamp) when ready
