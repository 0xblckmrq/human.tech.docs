...
If we decide to move forward with your Stamp, the next step is to follow the instructions in [this guide](/passport/building-with-passport/stamps/create-a-stamp/integrating-a-new-stamp).
