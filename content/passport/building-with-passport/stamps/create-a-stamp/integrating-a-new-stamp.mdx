...
If you haven't been approved yet, please visit the [Stamps overview for developers](/passport/building-with-passport/stamps/create-a-stamp) page, and follow the steps there. 
</Callout>
...
As an example, see the tests for the [ETH transaction credential](https://github.com/passportxyz/passport/blob/main/platforms/src/ETH/__tests__/ethTransactions.test.ts).
