...
For complete API documentation, see the [Stamps API reference](/passport/building-with-passport/stamps/passport-api).
...
- [Tutorial: Protecting Sensitive Programs](/passport/building-with-passport/embed/tutorials/protecting-sensitive-programs-with-passport-embed) - Complete walkthrough with backend verification
- [Stamps API Reference](/passport/building-with-passport/stamps/passport-api) - Full API documentation for server-side verification
