...
<Callout type="info">
**Please Note:**<br />
While Embed currently only works with the [Passport Stamps verificaiton flow](/passport/building-with-passport/stamps/passport-api), we are also working on enabling individual verification flows within Embed, including zk KYC, zk Biometrics, and zk Proof of Clean Hands.<br /><br />
