...
Please refer to our [tutorial](/passport/building-with-passport/embed/tutorials/protecting-sensitive-programs-with-passport-embed) to see an example of how to use this hook with a request to the Stamps API to confirm the score server-side (recommended for protecting sensitive programs).
...
To review a more in-depth example, see our [tutorial](/passport/building-with-passport/embed/tutorials/protecting-sensitive-programs-with-passport-embed). You can also use the **[Embed Playground](https://embed-playground.passport.xyz)** to configure the widget visually and generate code.
