...
<Callout type="info">
Looking to query attestations directly? See [Attestation Protocols](/passport/building-with-passport/individual-verifications/major-concepts/attestation-protocols) for Sign Protocol schema documentation and direct query methods.
</Callout>
...
<Callout type="info">
**Stellar** uses SBTs via Soroban smart contracts instead of the REST API. See the [Stellar Integration](/passport/building-with-passport/individual-verifications/supported-chains/stellar) page for Stellar-specific querying methods.
</Callout>

---

For more details on integration patterns, see the [Introduction](/passport/building-with-passport/individual-verifications/introduction).
