...
**EVM SBTs are legacy.** On EVM chains, SBTs have been replaced by attestations via Sign Protocol. For new EVM integrations, use the [API Reference](/passport/building-with-passport/individual-verifications/api-reference) or [Attestation Protocols](/passport/building-with-passport/individual-verifications/major-concepts/attestation-protocols).

**Stellar SBTs are current.** On Stellar, SBTs via Soroban are the active integration method. See the [Stellar Integration](/passport/building-with-passport/individual-verifications/supported-chains/stellar) page for complete details.
</Callout>
...
For all new integrations, use [Attestation Protocols](/passport/building-with-passport/individual-verifications/major-concepts/attestation-protocols) instead.
...
For complete Stellar SBT querying examples (TypeScript and Soroban/Rust), see the [Stellar Integration](/passport/building-with-passport/individual-verifications/supported-chains/stellar#querying-sbts) page.
...
2. **Direct contract queries**: Switch to [Sign Protocol queries](/passport/building-with-passport/individual-verifications/major-concepts/attestation-protocols)
...
- [Attestation Protocols](/passport/building-with-passport/individual-verifications/major-concepts/attestation-protocols) - Recommended integration method
- [API Reference](/passport/building-with-passport/individual-verifications/api-reference) - Simple verification status checks
- [Stellar Integration](/passport/building-with-passport/individual-verifications/supported-chains/stellar) - Stellar-specific integration guide
