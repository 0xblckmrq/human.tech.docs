...
<Callout type="info">
For a simpler integration, use the [Individual Verifications API](/passport/building-with-passport/individual-verifications/api-reference) which provides convenient endpoints that handle attestation queries for you.
</Callout>
...
For more information on action IDs and custom action IDs, see [Action IDs](/passport/building-with-passport/individual-verifications/major-concepts/action-ids).
...
- [Individual Verifications API](/passport/building-with-passport/individual-verifications/api-reference) - Simpler API for verification checks
