...
| Server-side checks | [API](/passport/building-with-passport/individual-verifications/api-reference) - simple true/false queries |
| On-chain contracts | [Attestation Protocols](/passport/building-with-passport/individual-verifications/major-concepts/attestation-protocols) - query Sign Protocol directly |
